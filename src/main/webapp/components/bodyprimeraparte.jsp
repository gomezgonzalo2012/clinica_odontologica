<%-- 
    ...
    Created on : 25 ene 2024, 23:07:41
    Author     : gomez
--%>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-solid fa-tooth"></i><!<!-- icono diente -->
                </div>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    <i class="fas fa-solid fa-bars"></i> <!-- menu icon-->
                    <span>Menú</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOdontologo" class="collapse" aria-labelledby="headingOdontologo" data-parent="#accordionSidebar">
