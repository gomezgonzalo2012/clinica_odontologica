...
public class Turno implements Serializable{
    ...
    @ManyToOne
    @JoinColumn(name="id_turno1")
    private Odontologo odonto; // relacion bidireccional: 1 odontolo esta en muchos turnos
    @ManyToOne
    @JoinColumn(name="id_turno2")
    private Paciente pacien;// relacion bidireccional: 1 paciente esta en muchos turnos
    public Turno() {
    }
